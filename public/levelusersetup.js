...
// DATA STORE
// =============================================
var STORE_KEY = 'level_userform_v1';

var defaultData = {
  companies:   ['Level Homes'],
  domains:     ['levelbr.com'],
  departments: ['Construction','Administration','Sales','Finance','IT','HR','Marketing','Design'],
  jobTitles:   ['Administrator','Project Manager','Sales Representative','Superintendent','Coordinator'],
...
function exportLists(){
  ...
  a.href     = url;
  a.download = 'LevelUserSetup-lists-' + new Date().toISOString().slice(0, 10) + '.json';
